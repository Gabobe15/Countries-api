...
const Africa = () => {
	...
	const africa = countries.filter((a) => {
	...
	let currentItems = africa.slice(indexOfFirstItem, indexOfLastItem); // it is going to show the first and last page 0-4, this mean it consist of four pages
	const totalPages = Math.ceil(africa.length / itemPerPage); // 10/5 = 2 page
	...
	return (
		<>
			...
			<div className="country">
				...
				{africa.length < 1 && <p>No country found</p>}
			</div>
